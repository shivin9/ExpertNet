...
# do
#     echo "k = $(($j))" >> Results/results_CAC.txt
#     python3 ../deepcac.py --dataset adult --n_clusters $j --alpha 1 --beta 20 --gamma 0 --delta 0 --eta 5 --log_interval 2 --attention False --verbose False --n_epochs 100 --n_classes 2 --n_z 32 >> Results/results_CAC.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_CAC.txt
#     python3 ../deepcac.py --dataset creditcard --n_clusters $j --alpha 1 --beta 20 --gamma 0 --delta 0 --eta 5 --log_interval 2 --attention False --verbose False --n_epochs 100 --n_classes 2 --n_z 32 >> Results/results_CAC.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_CAC.txt
#     python3 ../deepcac.py --dataset magic --n_clusters $j --alpha 1 --beta 20 --gamma 0 --delta 0 --eta 5 --log_interval 2 --attention False --verbose False --n_epochs 100 --n_classes 2 --n_z 32 >> Results/results_CAC.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_CAC.txt
#     python3 ../deepcac.py --dataset titanic --n_clusters $j --alpha 1 --beta 20 --gamma 0 --delta 0 --eta 5 --log_interval 2 --attention False --verbose False --n_epochs 100 --n_classes 2 --n_z 32 >> Results/results_CAC.txt
# done