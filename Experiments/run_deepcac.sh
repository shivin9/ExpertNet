...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset cic --n_clusters $j --alpha 1 --beta 2 --gamma 0 --delta 0 --eta 2 --attention False --log_interval 2 --n_epochs 50 --n_z 32 >> Results/results_CAC.txt
done
