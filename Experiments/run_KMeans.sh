...
# do
#     echo "k = $(($j))" >> Results/results_KM.txt
#     python3 ../KMeans.py --dataset aki_new --n_clusters $j --log_interval 2 --n_runs 3 --n_epochs 50 >> Results/results_KM.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_KM.txt
#     python3 ../KMeans.py --dataset ards_new --n_clusters $j --log_interval 2 --n_runs 3 --n_epochs 50 >> Results/results_KM.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_KM.txt
#     python3 ../KMeans.py --dataset cic_new --n_clusters $j --log_interval 2 --n_runs 3 --n_epochs 50 >> Results/results_KM.txt
# done
...
do
    echo "k = $(($j))" >> Results/results_KM.txt
    python3 ../KMeans.py --dataset cic_los --n_clusters $j --log_interval 2 --n_runs 3 --n_epochs 50 --n_classes 3  >> Results/results_KM.txt
done
...
do
    echo "k = $(($j))" >> Results/results_KM.txt
    python3 ../KMeans.py --dataset heart --n_clusters $j --log_interval 2 --n_runs 3 --n_epochs 50 --n_z 32 >> Results/results_KM.txt
done
