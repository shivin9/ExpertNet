...
python3 ../../baseline.py --dataset FashionMNIST --n_runs 1 --verbose False --n_epochs 100 --ae_type cnn --n_classes 10 --data_ratio 0.5 >> Results/results_Baseline.txt
python3 ../../baseline.py --dataset FashionMNIST --n_runs 1 --verbose False --n_epochs 100 --ae_type cnn --n_classes 10 --data_ratio 1 >> Results/results_Baseline.txt
python3 ../../baseline.py --dataset FashionMNIST --n_runs 1 --verbose False --n_epochs 100 --ae_type cnn --n_classes 10 --data_ratio 2 >> Results/results_Baseline.txt
python3 ../../baseline.py --dataset FashionMNIST --n_runs 1 --verbose False --n_epochs 100 --ae_type cnn --n_classes 10 --data_ratio 5 >> Results/results_Baseline.txt