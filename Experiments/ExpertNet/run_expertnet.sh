...
# echo "ExpertNet" >> Results/results_EN.txt
# echo "WID Mortality" >> Results/results_EN.txt

# for j in 2 3 4 5
# do
#     echo "k = $(($j))" >> Results/results_EN.txt
#     python3 ../../expertnet.py --dataset wid_mortality --n_clusters $j --alpha 1 --beta 2 --gamma 10 --delta 0.1 --log_interval 2 --n_epochs 100 --n_z 32  >> Results/results_EN.txt
# done
