...
do
    echo "k = $(($j))" >> Results/results_KM.txt
    python3 ../../KMeans.py --dataset ards24 --n_clusters $j --log_interval 2 --n_epochs 100 --n_z 32 --n_runs 21 >> Results/results_KM.txt
done
...
do
    echo "k = $(($j))" >> Results/results_KM.txt
    python3 ../../KMeans.py --dataset sepsis24 --n_clusters $j --log_interval 2 --n_epochs 100 --n_z 32 --n_runs 21 >> Results/results_KM.txt
done
