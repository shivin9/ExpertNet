...
# do
#     echo "k = $(($j))" >> Results/results_DCN.txt
#     python3 ../../DCN.py --dataset aki48 --n_clusters $j --alpha 1 --beta 2 --log_interval 2 --n_epochs 100 --n_z 32 >> Results/results_DCN.txt
# done
...
do
    echo "k = $(($j))" >> Results/results_DCN.txt
    python3 ../../DCN.py --dataset ards24 --n_clusters $j --alpha 1 --beta 2 --log_interval 2 --n_epochs 100 --n_z 32 >> Results/results_DCN.txt
done
...
do
    echo "k = $(($j))" >> Results/results_DCN.txt
    python3 ../../DCN.py --dataset sepsis24 --n_clusters $j --alpha 1 --beta 2 --log_interval 2 --n_epochs 100 --n_z 32 >> Results/results_DCN.txt
done
