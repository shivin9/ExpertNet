...
python3 ../../baseline.py --dataset sepsis --n_epochs 50 --gamma 1 --n_runs 5 --n_z 32 >> Results/results_Baseline.txt

echo "Kidney" >> Results/results_Baseline.txt
python3 ../../baseline.py --dataset aki --n_epochs 50 --gamma 1 --n_runs 5 --n_z 32 >> Results/results_Baseline.txt

echo "Respiratory" >> Results/results_Baseline.txt
python3 ../../baseline.py --dataset ards --n_epochs 50 --gamma 1 --n_runs 5 --n_z 32 >> Results/results_Baseline.txt
