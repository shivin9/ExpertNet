...
#     python3 ../deepcac.py --dataset cic --n_clusters $j --alpha 1 --beta 0.5 --gamma 1.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50 >> Results/results_EN.txt
# done
...
do
    echo "k = $(($j))" >> Results/results_EN.txt
    python3 ../deepcac.py --dataset cic_los --n_clusters $j --alpha 1 --beta 0.5 --gamma 1.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50 --n_classes 3 >> Results/results_EN.txt
done