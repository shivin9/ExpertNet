...
# do
#     echo "k = $(($j))" >> Results/results_EN.txt
#     python3 ../expertnet.py --dataset aki_new --n_clusters $j --alpha 1 --beta 2 --gamma 2.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50 >> Results/results_EN.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_EN.txt
#     python3 ../expertnet.py --dataset ards_new --n_clusters $j --alpha 1 --beta 2 --gamma 2.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50 >> Results/results_EN.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_EN.txt
#     python3 ../expertnet.py --dataset cic_new --n_clusters $j --alpha 1 --beta 2 --gamma 2.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50 >> Results/results_EN.txt
# done
...
# do
#     echo "k = $(($j))" >> Results/results_EN.txt
#     python3 ../expertnet.py --dataset cic_los_new --n_clusters $j --alpha 1 --beta 2 --gamma 2.5 --delta 1 --eta 0.0 --log_interval 2 --n_epochs 50  --n_classes 3 >> Results/results_EN.txt
# done
