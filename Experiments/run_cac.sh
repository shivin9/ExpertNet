...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset aki --n_clusters $j --alpha 1 --beta 0 --gamma 0 --delta 0 --eta 0.04 --attention False --log_interval 2 --n_epochs 50 --n_z 32 >> Results/results_CAC.txt
done
...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset ards --n_clusters $j --alpha 1 --beta 0 --gamma 0 --delta 0 --eta 0.04 --attention False --log_interval 2 --n_epochs 50 --n_z 32 >> Results/results_CAC.txt
done
...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset adult --n_clusters $j --alpha 1 --beta 0 --gamma 0 --delta 0 --eta 0.04 --log_interval 2 --attention False --n_epochs 50 --n_classes 3 --n_z 32 >> Results/results_CAC.txt
done
...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset creditcard --n_clusters $j --alpha 1 --beta 0 --gamma 0 --delta 0 --eta 0.04 --log_interval 2 --attention False --n_epochs 50 --n_classes 3 --n_z 32 >> Results/results_CAC.txt
done
...
do
    echo "k = $(($j))" >> Results/results_CAC.txt
    python3 ../deepcac.py --dataset magic --n_clusters $j --alpha 1 --beta 0 --gamma 0 --delta 0 --eta 0.04 --log_interval 2 --attention False --n_epochs 50 --n_classes 3 --n_z 32 >> Results/results_CAC.txt
done